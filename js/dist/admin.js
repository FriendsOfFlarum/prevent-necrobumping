...
/* harmony import */ var _fof_components_admin_settings_items_NumberItem__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @fof/components/admin/settings/items/NumberItem */ "./node_modules/@fof/components/admin/settings/items/NumberItem.js");


app.initializers.add('fof/prevent-necrobumping', function () {
  app.extensionSettings['fof-prevent-necrobumping'] = function () {
    return app.modal.show(new _fof_components_admin_settings_SettingsModal__WEBPACK_IMPORTED_MODULE_0__["default"]({
      ...
      size: 'medium',
      items: [m("p", null, app.translator.trans('fof-prevent-necrobumping.admin.settings.days_help')), m(_fof_components_admin_settings_items_NumberItem__WEBPACK_IMPORTED_MODULE_1__["default"], {
        key: "fof-prevent-necrobumping.days",
        min: "1"
