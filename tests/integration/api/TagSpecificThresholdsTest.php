...
class TagSpecificThresholdsTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->prepareDatabase([
            ...
            Tag::class => [
                ['id' => 1, 'name' => 'General', 'slug' => 'general', 'is_primary' => true, 'position' => 0],
                ['id' => 2, 'name' => 'Support', 'slug' => 'support', 'is_primary' => true, 'position' => 1],
                ['id' => 3, 'name' => 'News', 'slug' => 'news', 'is_primary' => true, 'position' => 2],
            ],
            Discussion::class => [
